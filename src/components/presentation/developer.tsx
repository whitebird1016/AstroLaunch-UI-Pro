      ...
      <div className="h-full w-screen place-items-center bg-white py-20">
        <div className="container mx-auto items-center relative">
          <div className="text-center mb-8">
            <Typography
              color="blue"
              className="flex items-center font-bold text-lg justify-center mb-5"
            >
            ...
            <Typography color="blue-gray" className="lg:px-64">
        ...
        <img src="blocks.png" alt="components" className="mx-auto hidden md:flex" />
      </div>
    </ThemeProvider>
  );
}
